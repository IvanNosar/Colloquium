package group41.student.com.colloquium.controller.ui.Employee;
...
public class VacancyPreviewAdapter {
    ...
    private View generateView(final VacancyPreview data, final VacancyPreviewClickHandler handler) {
        ...
        View result = mLayoutInflater.inflate(R.layout.view_employee_vacancy_preview, mContainer, false);
